...
import { ESTADO_BADGE_CLASSES, ESTADO_DOT_CLASSES, ESTADO_RING_CLASSES, ESTADO_LABELS } from '@/shared/constants/estados.const';

@Component({
    selector: 'app-denuncia-history',
    standalone: true,
    imports: [CommonModule, UiStyleDirective, DatePipe],
