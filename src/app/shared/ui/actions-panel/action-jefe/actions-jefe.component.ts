...
export class ActionsJefeComponent {
    ...
    // Recibimos la denuncia actual para ver su estado
    // currentDenuncia = input.required<DenunciaStaffViewResponse>();
    currentDenuncia = input<DenunciaStaffViewResponse>({
        id: 999,
        titulo: 'Denuncia Mock para UI',
        estado: 'RECIBIDA',
        datosCiudadano: 'Ciudadano Mock',
        ciudadanoId: 100,
        evidenciaIds: []
    });
